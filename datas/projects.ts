...
export const projects: Projects[] = [
  {
    title: "Nabiq AI",
    subtitle: "Human like AI salesman for all your website visitors",
    description:
      "Nabiq is an AI Sales Development Representative that engages with every customer in a personalized fashion using data from your website and third-party integrations.",
    image: "/nabiq_ai.gif",
    link: "https://nabiq.markopolo.ai/",
  },
  {
    title: "Deepdive",
    subtitle: "Generate AI driven sentiment reports",
    description:
      "Actionable Consumer Intelligence with Social Listening AI │ Trusted by Global Brands like Olay, bKash, and Pepsico",
    image: "/deepdive_v2.gif",
    link: "https://deepdive.markopolo.ai/",
  },
  {
    title: "Hishabee",
    subtitle: "Frontend Stack (NextJS)",
    description:
      "Hishabee web app is the larget online business for the retailer, merchant and small shop. Almost 1.5M user used in our web app daily",
    image: "/hishabee.png",
